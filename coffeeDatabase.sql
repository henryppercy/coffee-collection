...
# Generation Time: 2022-09-29 16:00:05 +0000
# ************************************************************
...
LOCK
TABLES `coffees` WRITE;
/*!40000 ALTER TABLE `coffees` DISABLE KEYS */;

INSERT INTO `coffees` (`id`, `name`, `origin`, `process`, `descriptor_one`, `descriptor_two`, `descriptor_three`,
                       `altitude`, `image`)
VALUES (1, ''Brazil Classico'', 1, 1, ''Honey'', ''Sugarcane Molasses '', ''Hazelnut'', 1500, ''images/coffee-1.jpeg''),
       (2, ''BS1 Espresso'', 2, 2, ''Milk Choc'', ''Sticky Caramel'', ''Red Fruit'', 2000, ''images/coffee-10.jpeg''),
       (3, ''Indonesia Kerinchi'', 4, 1, ''Cherry Choc'', ''Lemon'', ''Brown Spice'', 1700, ''images/coffee-2.jpeg''),
       ...
       (7, ''Santa Elena'', 19, 2, ''Clementine'', ''Plum'', ''Sugarcane'', 1900, ''images/coffee-11.jpeg'');
